...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("9. Asignar pokemon a un entrnador");
            System.out.println("10. Eliminar pokemon de un entrenador");
    ...
    private static void eliminarPokemon() {
        ...
        System.out.print("Ingrese el id del pokemon a eliminar: ");
        id = input.nextInt();
        input.nextLine();
    ...
    private static void eliminarEntrenador() {
        ...
        try {
            PreparedStatement pstmt = conn.prepareStatement(eliminarEntrenadorSQL);
            pstmt.setInt(1, id);
            pstmt.executeUpdate();
